        ...
        // ----------------------------------------------------------------
            ...
            switch ($sousPage) {
                ...
                case 'stocks':
                    ...
                    $action = $url[2] ?? 'index';
                    if (in_array($action, ['index', 'entree', 'sortie', 'historique', 'modifierStock', 'ajouterTaille', 'supprimerTaille', 'ajouterEntree', 'ajouterEntreeAjax', 'ajouterSortie', 'ajouterSortieManuelle', 'exportCsv', 'exportPdf', 'resetStock'])) {
                        $this->method = $action;
                        $this->params = isset($url[3]) ? [$url[3]] : [];
                    }
                    break;
